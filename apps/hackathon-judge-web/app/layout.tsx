...
const siteUrl = 'https://hackathon-judge-studionet.blazekingsley2.chatgpt.site';
const socialImageUrl = `${siteUrl}/hackathon-judge-social.png`;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: socialImageUrl, width: 1792, height: 1024, alt: 'Hackathon Judge — rules, evidence, consensus' }],
  },
  twitter: {
